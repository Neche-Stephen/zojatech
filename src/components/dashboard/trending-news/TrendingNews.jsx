      ...
      <div className="flex flex-col gap-3">
        {news.map((item, index) => {
          return (
            <div
              key={index}
              className=" bg-white p-4 rounded-xl flex items-center gap-2 shadow border border-[#f1f1f1] "
            >
              <div className="">
              ...
              <div>
                <div className="text-[#3a3a45] text-sm font-semibold font-['Lexend']">
                  {item.title}
                </div>
                <div className="text-[#808086] text-xs font-light font-['Lexend'] leading-none">
                  {item.subtitle}
                </div>
              </div>
            </div>
