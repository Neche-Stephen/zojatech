...
import styles from "./Sidebar.module.scss";
 ...
 const Sidebar = () => {
  ...
  return (
      <div className={`${styles.hide_scrollbar} lg:fixed top-0 left-0 h-screen overflow-y-auto lg:w-[17.4%] bg-white shadow-md flex flex-col justify-between items-center `}>
        {/* Logo */}
        <div className="">
